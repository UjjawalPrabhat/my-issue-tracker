        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/updates" className="text-gray-600 hover:text-gray-900">Updates</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-gray-600">Email: support@campus-track.com</li>
              <li className="text-gray-600">Phone: (555) 123-4567</li>
              <li className="text-gray-600">Location: Campus Main Building</li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              © {new Date().getFullYear()} Campus Issue Tracker. All rights reserved.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <Link to="/cookies" className="text-sm text-gray-500 hover:text-gray-900">Cookies</Link>
            </div>
          </div>
        </div>
      </div>
