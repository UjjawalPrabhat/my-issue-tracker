      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-sm text-gray-600">
              A comprehensive solution for managing campus issues, service requests, and maintenance needs.
              Streamline your campus operations with our efficient tracking system.
            </p>
          </div>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-base text-gray-500">
            &copy; {new Date().getFullYear()} Campus Issue Tracker. All rights reserved.
          </p>
