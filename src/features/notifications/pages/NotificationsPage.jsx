...
import { getUserNotifications, markAllAsRead } from '../../../services/notifications';
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        ...
        // Get appropriate notifications based on user role
        const role = isAdmin ? 'admin' : 'student';
        const data = await getUserNotifications(user.uid, role);
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    {isAdmin 
                      ...
                      : 'Stay updated with your issue status and campus announcements'}
                  </p>
                  {unreadCount > 0 && (
                    <div className="mt-2">
